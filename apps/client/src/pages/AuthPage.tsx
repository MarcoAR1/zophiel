...
export default function AuthPage() {
  ...
  /* ═══ Google Button — exact Stitch Pro style: outlined/transparent ═══ */
  const googleButton = isNative ? (
    <button
      type="button"
      className="w-full flex items-center justify-center gap-3 py-3.5 px-6 border border-white/20 rounded-xl bg-transparent hover:bg-white/5 transition-colors group"
