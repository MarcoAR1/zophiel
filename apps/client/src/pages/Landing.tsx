          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-col lg:flex-row gap-4 w-full lg:w-auto">
                ...
                <a href="https://zophielserver-production.up.railway.app/api/download/apk" target="_blank" rel="noopener noreferrer" className="hidden lg:flex h-12 px-8 rounded-xl bg-white/5 border border-white/10 text-white text-base font-bold hover:bg-white/10 transition-colors backdrop-blur-sm items-center justify-center gap-2 no-underline">
                  <span className="material-symbols-outlined text-[20px]">download</span>
                  Descargar APK
                </a>
              </div>
              ...
              <div className="hidden lg:flex mt-10 items-center gap-3 text-sm text-slate-500">
                ...
                <p className="m-0">Disponible para <a href="https://zophielserver-production.up.railway.app/api/download/apk" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-white transition-colors no-underline font-semibold">Android</a> y como <span className="text-white font-semibold">PWA</span></p>
              </div>
            </div>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-0">
              ...
              <div className="flex-1 text-center lg:text-left lg:p-16">
                ...
                <div className="flex flex-col sm:flex-row gap-3 items-center justify-center lg:justify-start">
                  <a
                    href="https://zophielserver-production.up.railway.app/api/download/apk"
